...
namespace ConsoleTest
{
	public class CronNetTest
	{
		...
		public void Handle()
		{
			...
			var cronSchedule = new CronSchedule("0 16 11,12,14,16,18 * * ? ");
			var  latests= cronSchedule.QueryLatestTimes();
			foreach (var time in latests)
			{
				Console.WriteLine($"isTime:{time}");
			}
